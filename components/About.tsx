...
export default function AboutSection() {
  ...
  const timeline = [
    {
      year: "January 2026",
      text: "Winning Consulting - Full Stack Developer",
    },
    {
      year: "September 2025",
    ...
    {
      year: "June 2020",
      text: "LogicWise - Internship as Frontend Developer",
    },
    {
      year: "June 2019",
      text: "LogicWise - Internship as Frontend Developer",
    ...
    {
      year: "September 2017",
      text: "Professional Course in Computer Equipment Management",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        Hey, my name is Diogo and I’m a Computer Engineering graduate passionate
        about building efficient, user-focused web applications. With hands-on
